            ...
            <form role="form" action="{{ route('category.update', $category)}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group {{ $errors->has('name') ? 'invalid' : '' }}">
                    ...
                    <input type="text" class="form-control" name="name" value="{{ $category->name ?? old('name')}}" placeholder="Masukkan Nama Kategori">
                    @if ($errors->has('name'))
                    <span class="text-red">
                        {{ $errors->first('name') }}
                    </span>
                ...
                <div class="form-group {{ $errors->has('description') ? 'invalid' : '' }}">
                    ...
                    <input type="text" class="form-control" name="description" value="{{ $category->description ?? old('description')}}" placeholder="Masukkan Deskripsi Kategori">
